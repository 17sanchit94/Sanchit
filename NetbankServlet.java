...
public class NetbankServlet extends HttpServlet
{
    public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
    {
        ...
        try
        {
            ...
            ResultSet rs=s.executeQuery("select * from BANK where CARD_NUMBER="'+cardno+'" and BANK_NAME="'+bankname+'"");
            if(rs.next())
            {
                //out.println("matched");
                out.println("<html><body><h1>Thank you for Buyying. Happy Shopping!!</h1></body></html>");
